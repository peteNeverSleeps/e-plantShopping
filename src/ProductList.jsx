...
function ProductList() {
  ...
  const [addedToCart, setAddedToCart] = useState({}); // Tracks which plants have been added

  const dispatch = useDispatch();

  // Array of plants grouped by category.
  const plantsArray = [
    {
  ...
  const handleAddToCart = (plant) => {
    dispatch(addItem(plant)); // Dispatch plant details to the Redux store.
    setAddedToCart({ ...addedToCart, [plant.name]: true }); // Mark plant as added.
  };
